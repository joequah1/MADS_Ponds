    ...
    this.app.contentTag.innerHTML =
        '<div class="container"> \
            <div id="layer-1" class="layer"> \
                <img src="' + this.app.path + 'images/ponds01-bg.png"/> \
                <div id="redeem_container"> \
                    <img src="' + this.app.path + 'images/ponds01-bttn1.png" id="redeem"/> \
                    <img src="' + this.app.path + 'images/ponds01-bttn2.png" id="coupon"/> \
...
ponds.prototype.style = function () {
    ...
    style = document.createElement('style');1111
